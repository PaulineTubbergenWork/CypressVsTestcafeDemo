import { titeltekst, urls, welkomsttekst, welkomsttekstTikfout, zoeken } from '../page_objects/wikipedia.po';
...
test('Fails on purpose', async t => {
    // go to the English Wikipedia page
    // check that the page is in English
    await t.expect(welkomsttekstTikfout.innerText).contains('Welcome to')
    // search for the Platypus
    await t
        .typeText(zoeken.zoekveld, 'Platypus')
        .click(zoeken.zoekknop)
